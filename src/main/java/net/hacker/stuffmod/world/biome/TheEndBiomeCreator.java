...
public class TheEndBiomeCreator {
    ...
    public static Biome createTheEnd(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup) {
        GenerationSettings.LookupBackedBuilder lookupBackedBuilder = (new GenerationSettings.LookupBackedBuilder(featureLookup, carverLookup)).feature(Feature.SURFACE_STRUCTURES, EndPlacedFeatures.END_SPIKE);
        return createEndBiome(lookupBackedBuilder);
    }
    ...
    public static Biome createEndHighlands(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup) {
        GenerationSettings.LookupBackedBuilder lookupBackedBuilder = (new GenerationSettings.LookupBackedBuilder(featureLookup, carverLookup)).feature(Feature.SURFACE_STRUCTURES, EndPlacedFeatures.END_GATEWAY_RETURN).feature(Feature.VEGETAL_DECORATION, EndPlacedFeatures.CHORUS_PLANT);
        return createEndBiome(lookupBackedBuilder);
    }
    ...
    public static Biome createSmallEndIslands(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup) {
        GenerationSettings.LookupBackedBuilder lookupBackedBuilder = (new GenerationSettings.LookupBackedBuilder(featureLookup, carverLookup)).feature(Feature.RAW_GENERATION, EndPlacedFeatures.END_ISLAND_DECORATED);
        return createEndBiome(lookupBackedBuilder);
    }
}
